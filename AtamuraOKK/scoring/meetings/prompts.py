...
Parameterized by :class:`~AtamuraOKK.scoring.meetings.rubric.Rubric` so
adding/retiring a criterion is a rubric edit, never a prompt edit. Framing
adapts to ``rubric.context`` (ОП meeting by default).
"""
